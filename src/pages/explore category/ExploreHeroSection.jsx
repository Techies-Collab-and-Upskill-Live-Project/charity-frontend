        ...
        <div className="py-10 lg:py-20">
          <div className="grid gap-10 lg:grid-cols-2 mt-10 lg:mt-20 ">
            <div className=" mt-0 sm:mt-5 ">
              <Link to="/discover" className="flex items-center space-x-1">
              ...
              <p className="text-gray-500 max-w-full">
                Explore campaigns dedicated to ensuring the well-being and
                bright future of every child. Your support can make a lasting
            ...
            <div className="mt-6 sm:mt-0">
              <img
                ...
                alt="explore_image"
                className="object-cover w-full h-56 rounded shadow-lg sm:h-[300px]"
                loading="lazy"
              />
            </div>
          </div>
