        ...
        <div className="max-w-md w-full mx-auto mt-10 ">
          ...
          <div className=" bg-white shadow-md border p-4 mt-4">
            ...
            <p className=" max-w-md text-[0.87rem] text-[#6C6C6C] mt-4">
              Lorem ipsum dolor sit amet consectetur. Diam mattis sit risus
              ultrices vivamus. Leo velit ut arcu et scelerisque netus varius.
              Cursus a facilisi turpis urna elementum velit fringilla risus
              scelerisque. Fringilla justo egestas sociis sem diam ante platea.
              Faucibus
            </p>
          </div>
        </div>
