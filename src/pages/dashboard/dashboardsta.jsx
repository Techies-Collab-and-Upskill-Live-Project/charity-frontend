...
const DashboardSta = () => {
  ...
  const [user, setUserData] = useState(null); // State to hold the fetched data
  const axiosInstance = useApiService(); // Get the Axios instance from your custom hook

  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axiosInstance.get("/auth/profile/get/"); // Use the Axios instance to make a GET request
        console.log("user profile", response.data); // Log the fetched data (for debugging purposes
        setUserData(response.data); // Set the fetched data to your state
      } catch (error) {
        ...
        <div className="rounded-lg bg-[#FAFAFA] shadow-md lg:col-span-2 p-4">
          <div>
            <div className=" flex justify-between">
              <p className=" text-[#101928] font-bold text-[0-80] leading-normal">
                Statistics
              </p>
          ...
          <div className="rounded-lg bg-[#FFF] shadow-md p-4 mt-6 ">
            <div className=" flex justify-end">
              <div className=" bg-[#E6F6F3] rounded-full w-32 h-6 flex items-center justify-center">
                <div className=" flex items-center space-x-2">
                  ...
                  <span className=" text-[#04A38A] font-medium leading-[18px] text-xs">
                    In consideration
                  </span>
                </div>
              </div>
            ...
            <div className=" flex flex-col space-y-2 mt-4">
              <div className=" flex space-x-4 items-center">
                ...
                <div>
                  <p className="text-base font-semibold leading-normal text-[#252525]">
                    20/12/2023
                  </p>
                </div>
              </div>
              ...
              <div className=" flex space-x-4 items-center">
                <div className=" flex-shrink-0  relative">
                  ...
                  <img
                    src="/assets/img2"
                    alt=""
                    className="w-8 h-8 rounded-full text-[#04A38A] "
                  />
                </div>
                <div>
                  <p className="text-base font-semibold leading-normal text-[#252525]">
            ...
            <div className=" flex justify-end">
              <div className=" bg-[#FFFAEB] rounded-full w-24 h-6 flex items-center justify-center">
                <div className=" flex items-center space-x-2">
                  ...
                  <span className=" text-[#B54708] font-medium leading-[18px] text-xs">
                    In session
                  </span>
                </div>
              </div>
