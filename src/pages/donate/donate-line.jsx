                    ...
                    <div className=" flex justify-between max-sm:flex-col">
                        <div>
                            ...
                            <div className="flex mt-5">
                                ...
                                <h6 className="mt-2 ml-2">Ahmed Tinubu </h6>
                                <p className="mt-2 ml-2 text-gray-500"> started this fundraiser</p>
                            </div>
                                                ...
                                                <div>
                                                    <div className="bg bg-orange-50 py-3 px-9 container mt-10 max-sm:px-3">
                                                        <div className="flex">
                                                            <img src={donationimg} alt="" />
                                                            <h6 className="mt-2 ml-2">Ahmed Tinubu </h6>
                                                            <p className="mt-2 ml-2 text-gray-500">-fundraiser</p>
                                                        </div>
                                                        <div className="flex mt-5">
                                                            <div className="flex">
                                                                <img src={calendarimg} alt="" />
                                                        ...
                                                        <p className="mt-5">
                                                            Step into a journey of compassion and change with our monumental campaign, "Hearts United for Hope." In the vast landscapes of Africa, where young hearts beat with dreams yet to unfold, we invite you to
                                                            become a beacon of light and love. This initiative is more than a mere fundraiser; it's a movement to uplift, empower, and secure a brighter tomorrow for orphaned children.
                                                        </p>
                                                        <p className="mt-5">
                                                            Picture a world where every child has the chance to thrive, regardless of their circumstances.
                                                            That's the vision we're weaving into reality, and we invite you to be a vital thread in this tapestry of transformation. Your support goes beyond monetary contributions; it's a promise to these children that they are seen, heard, and valued.From providing quality education and nurturing environments to fostering talents and dreams, your generosity becomes the catalyst for a positive ripple effect. Each donation, every share,
                                                            and the collective energy of our community resonate far beyond the immediate impact, creating a legacy of love that transcends borders and generations.
                                                        </p>
                                                        <p className="mt-5">
                                                            Join us on this extraordinary journey. Let's stand united, hearts entwined, as we make a profound and lasting difference in the lives of these resilient souls. Together, we can rewrite the narrative for orphaned children in Africa, turning every challenge into an opportunity and every dream into a reality. Hearts United for Hope—because
                                                            transformation begins with compassion, and change starts with us.
                                                        </p>
                                                    ...
                                                    <div className="bg bg-orange-50 py-3 px-9 container mt-10 max-sm:px-3">
                                                        ...
                                                        <p className="mt-5">
                                                            Step into a journey of compassion and change with our monumental campaign, "Hearts United for Hope." In the vast landscapes of Africa,
                                                            where young hearts beat with dreams yet to unfold, we invite you to become a beacon of light and love. This initiative is more than a mere fundraiser;
                                                            it's a movement to uplift, empower, and secure a brighter tomorrow for orphaned children.
                                                        </p>
                                                        <p className="mt-5">
                                                            Picture a world where every child has the chance to thrive, regardless of their circumstances.
                                                            That's the vision we're weaving into reality, and we invite you to be a vital thread in this tapestry of transformation.
                                                            Your support goes beyond monetary contributions; it's a promise to these children that they are seen, heard, and valued.
                                                            From providing quality education and nurturing environments to fostering talents and dreams, your generosity becomes the catalyst for a positive ripple effect.
                                                            Each donation, every share, and the collective energy of our community resonate far beyond the immediate impact,
                                                            creating a legacy of love that transcends borders and generations.
                                                        </p>
                                                        <p className="mt-5">
                                                            Join us on this extraordinary journey. Let's stand united, hearts entwined, as we make a profound and
                                                            lasting difference in the lives of these resilient souls. Together, we can rewrite the narrative for orphaned children in Africa, turning every challenge
                                                            into an opportunity and every dream into a reality. Hearts United for Hope—because transformation begins with compassion, and change starts with us.
                                                        </p>
                                                        <img src={selectedActivity.CoverImg} alt="" className="mt-5 rounded-xl" />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mt-10">
                                                    <div className="flex">
                                                        ...
                                                        <div className="flex ">
                                                            ...
                                                            <p className="ml-32 max-sm:ml-0">$ 5</p>
                                                        </div>
                                                    </div>
                        ...
                        <div className="border-2 px-5 py-3 rounded-lg shadow-md max-sm:hidden" style={{ height: "100%" }}>
                            ...
                            <div className="flex flex-col mt-2">
                                <Link to={"/paymentpage"}>
                                    <button className="bg-teal-500 rounded-md px-3 text-white mt-5 w-96 h-14 font-bold text-base">
                                        Donate now
                                    </button>
                                </Link>
                                <button className="bg-white rounded-md px-3 text-teal-500 border-2 border-teal-500  font-bold text-base mt-5 w-96 h-14">
                                    Share Campaign
                                </button>
                            </div>
                            <hr className="mt-5 mb-5" />
