              ...
              <div className="hidden lg:block">
                <div className="border-2 px-4 py-3 bg-white rounded-lg shadow-md  ">
                  ...
                  <div className="flex flex-col mt-2">
                    <Link
                      key={campaign.id}
                      to={`/paymentpage/${campaign.id}`}
                      className="bg-teal-500 w-full rounded-md px-4 py-3 text-center text-white mt-5 font-bold text-base"
                    >
                      Donate now
                    </Link>
                    <button className="bg-white w-full rounded-md px-4 py-3 text-teal-500 border-2 border-teal-500  font-bold text-base mt-5 ">
                      {" "}
                      Share Campaign
                    </button>
                  </div>
            ...
            <div className="lg:hidden block mt-8">
              <div className="border-2 px-4 py-3 bg-white rounded-lg shadow-md  ">
                ...
                <div className="flex flex-col mt-2">
                  <Link
                    to={"/paymentpage"}
                    className="bg-teal-500 w-full rounded-md px-4 py-3 text-white mt-5 text-center font-bold text-base"
                  >
                    Donate now
                  </Link>
                  <button className="bg-white w-full rounded-md px-4 py-3 text-teal-500 border-2 border-teal-500  font-bold text-base mt-5 ">
