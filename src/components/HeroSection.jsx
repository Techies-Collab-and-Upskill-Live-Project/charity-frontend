                ...
                <div className="">
                  <div className=" mt-10 lg:mt-20">
                    ...
                    <p className="max-w-2xl font-sans font-bold leading-none  text-white sm:text-sm lg:text-md my-2">
                      Join us on a journey where your generosity knows no
                      bounds. Together, let's spark hope, share joy, and
                      transform lives through the extraordinary power of giving.
