      ...
      <div className=' bg-white w-full mx-auto'>
          <div className=' container mx-auto w-full'>
              <div className='py-36 md:py-12 mx-auto'>
                  <div className=''>
                      <h3 className="mb-4 tracking-wide text-center "> Our Impact Stories</h3>
                  </div>
                              ...
                              <div className="h-full bg-[#FAF4ED] p-8 rounded ">
                                  ...
                                  <div className="flex items-center">
                                      ...
                                      <span className="flex-grow flex flex-col pl-4">
                                          <span className="title-font font-medium text-gray-900">{testimonial.authorName}</span>
                                          <span className="text-gray-500 text-sm">{testimonial.authorRole}</span>
                                      </span>
                                  </div>
                              </div>
