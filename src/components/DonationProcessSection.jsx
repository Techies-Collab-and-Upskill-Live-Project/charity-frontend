    ...
    <div className="bg-white mx-auto w-full ">
      <div className=" container mx-auto w-full">
        <div className="py-8 lg:py-12 pb-[350px]">
          <p className="text-start text-orange-400 text-base font-bold leading-normal">
            HOW TO DONATE
          </p>
          <div className="py-10  grid gap-10 lg:grid-cols-2 ">
            <div className="   mb-auto ">
              <h3 className=" text-neutral-800 max-w-xl">
                Making a Difference: Learning the Donation Process
              </h3>
              <p className=" text-neutral-600 text-base font-normal max-w-lg ">
                Empower Positive Change in a Few Simple Steps. Discover the
                Seamless Process of Donating on Donation Trace.
              </p>
            </div>
            ...
            <div className="grid gap-8 row-gap-0 lg:grid-cols-3">
              <div className="grow shrink basis-0 flex-col justify-start items-start gap-6 ">
                ...
                <h4 className=" text-neutral-800 pb-5">
                  Identify Campaigns Worth Supporting
                </h4>
                <p className=" text-neutral-600 text-base font-normal ">
                  Explore diverse campaigns, find one that aligns with your
              ...
              <div className="grow shrink basis-0 flex-col justify-start items-start gap-6 ">
                ...
                <p className=" text-neutral-600 text-base font-normal">
                  Flexible Payment Options—whether it's a quick debit card
                  transaction, a seamless bank transfer, or cryptocurrency.{" "}
                </p>
              </div>
              <div className="  flex-col justify-start items-start inline-flex">
                ...
                <h4 className=" text-neutral-700 sm:pb-5 pb-0 ">
                  Submit Your Donation
                </h4>
                <p className=" text-neutral-600 text-base font-normal">
                  Finalize your donation by submitting your payment, and watch
                  your support create meaningful change. Every contribution
                  counts, and we appreciate your commitment to making a positive
                  impact.
                </p>
              </div>
            </div>
