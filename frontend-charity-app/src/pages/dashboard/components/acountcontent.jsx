      ...
      <div className="mt-7">
        ...
        <div className='max-w-lg mx-auto '>
          <div className='w-40 h-40 rounded-full mx-auto bg-white border-2 border-[#C2C2C2] border-dotted flex flex-col items-center justify-center'>
            ...
            <p className=' text-[#12B76A] text-base font-semibold leading-normal'>Profile Photo</p>
          </div>
          <div className='mt-6'>
            <div className="flex items-center justify-center w-full">
              <label for="dropzone-file" className="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  <p className="mb-2 text-xs font-normal text-[#898989]"><span className="font-semibold text-sm text-[#04A38A]">Click to upload</span> or drag and drop</p>
                  <p class="text-xs font-normal text-[#898989]">SVG, PNG, JPG or GIF (MAX. 800x400px)</p>
                </div>
        ...
        <div className=' mt-6'>
          <h5 className=' text-[#161616] text-base font-bold'>Contact Information</h5>
          <p className=' text-[#7B7B7B] text-xs font-normal leading-tight mt-3'>Click to edit Contact information</p>
          <form className=' mt-6' >
            <div>
              <div className=" space-y-3">
                  <label htmlFor="selcteprefix" className="block text-[#252525] text-sm">Prefix</label>
                    <select name="selcteprefix" id="" className=" w-80 rounded-md ring-1 ring-inset ring-gray-300 focus:ring-2 focus:outline-none focus:ring-inset focus:ring-teal-500 font-medium  sm:text-sm px-4 py-2.5  " >
                ...
                <div className="space-y-3 mt-2">
                  <label htmlFor="firstName" className="block text-[#252525] text-sm">
                    First Name
                  </label>
              ...
              <div className=" space-y-3 mt-2">
                <label htmlFor="lastName" className="block text-[#252525] text-sm">
                  Last Name
                </label>
                <div className=" relative">
        ...
        {/*--- change password---*/}
         <div className=' mt-16'>
          <h5 className=' text-[#161616] text-base font-bold'>Change Password</h5>
          <p className=' text-[#7B7B7B] text-xs font-normal leading-tight mt-3'>Click to Change password</p>
          <form className=' mt-6' >
            <div>
              <div className="space-y-2">
                  <label htmlFor="password" className='block text-[#252525] text-sm'>Old password</label>
                  <div className=" relative">
              ...
              <div className="space-y-2 mt-2">
                <label htmlFor="password" className='block text-[#252525] text-sm'>New passsword</label>
                  <div className=" relative">
                    <span className="pointer-events-none inline-flex items-center justify-center absolute  inset-y-0 start-0  ps-3.5 left-0 top-0 h-full w-10 text-gray-400">
                      <RiLockPasswordLine className="h-4 w-4" />
                    </span>
                ...
                <div className="space-y-2 mt-2">
                  <label htmlFor="password" className='block text-[#252525] text-sm'>Confirm new password</label>
                  <div className=" relative">
                    <span className="pointer-events-none inline-flex items-center justify-center absolute  inset-y-0 start-0  ps-3.5 left-0 top-0 h-full w-10 text-gray-400">
                      <RiLockPasswordLine className="h-4 w-4" />
                    </span>
        ...
        {/*----- 2 step factor auth-----*/}
        <div className=' mt-16'>
           <h5 className=' text-[#3B3B3B] text-xl font-bold'>Two factor authentication (2FA)</h5>
          <p className=' text-[#7B7B7B] text-base font-normal leading-tight mt-3'>Setting up a  2FA adds an extra layer of security to protect your account.</p>
          <label className="relative inline-flex items-center cursor-pointer mt-6">
           ...
           <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none   rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-teal-600"></div>
            <span className="ms-3 text-xl font-normal text-[#4A4A4A] ">Enable Two-Factor authentication (2FA)</span>
          </label>
        </div>
        {/*------buttton ------*/}
...
export const UserEmail = () => {
  return (
    <div className=' mt-16'>
       <h5 className=' text-[#161616] text-base font-bold'>Change Email Address</h5>
      <p className=' text-[#7B7B7B] text-xs font-normal leading-tight mt-3'>Click to Change Email Address</p>
      <div className=" space-y-2 mt-2">
